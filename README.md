...
🧰 **Toolbox**
<ul>
    <li>IT Infrastructure: Windows Server, Microsoft Azure, Linux.</li>
    <li>Data Analysis: Microsoft PowerBI.</li>
    <li>Front-End Development: AngularJS, PHP.</li>
    <li>Back-End Development: Spring Boot.</li>
</ul>
...
<div>
    ...
    <img height='50em' src='https://github.com/tandpfun/skill-icons/blob/main/icons/Angular-Dark.svg' alt='AngularJS'>
